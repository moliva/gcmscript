...
/**
 * A GCM procedure to implement the <code>gcm-new()</code> action which instantiates a GCM component.
 *
 * @author The ProActive Team
 */
public class GCMNewAction extends AbstractGCMProcedure implements NativeProcedure, BindingController {
    /**
    ...
    public Signature getSignature() {
        return new Signature(model.getNodeKind("component"), STRING, new UnionType(model
                .getNodeKind("gcmapplication"), new NodeSetType(model.getNodeKind("gcmvirtualnode")),
            new NodeSetType(model.getNodeKind("gcmnode"))));
    }
    ...
    public Object apply(List<Object> args, Context ctx) throws ScriptExecutionError {
        ...
        try {
            ...
            Component newComp = (Component) getFactory().newComponent(adlName,
    ...
    private Factory getFactory() {
        try {
            return (Factory) model.lookupFc("gcm-factory");
